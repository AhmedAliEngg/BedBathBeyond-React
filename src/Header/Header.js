...
import ColorTabs from './Tabs.js/Tabs';
import CustomizedMenus from './DropDown/DropDown';
import CollapsedBreadcrumbs from './BreadCrums/BreadCrums';
    ...
    return (
        <div>
            <Box>
                <StyledAppBar>
                    <ColorTabs />
                    <Toolbar style={{ height: '12vh', marginLeft: '12ch' }}>
                        <div>
                            <img
                        ...
                        <Search style={{ position: 'relative' }}>
                            ...
                            <div style={{ color: 'black', position: 'absolute', left: '6cm', top: '10px', zIndex: '2' }}>
                                <SearchIcon />
                            </div>
                            <StyledInputBase
